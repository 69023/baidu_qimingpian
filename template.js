...
function get_json_data(t) {
    // return JSON.parse(s("5e5062e82f15fe4ca9d24bc5", decode(t), 0, 0, "012345677890123", 1))
    return s("5e5062e82f15fe4ca9d24bc5", decode(t), 0, 0, "012345677890123", 1).replace("%2525", "%")
}

var result = get_json_data(t);
